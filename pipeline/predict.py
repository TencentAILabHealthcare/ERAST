from filter import get_pfam_res,get_search_result,get_id_dict,filter
import numpy as np
import json
import argparse
...
def pipeline(out_path,pfam_q_path,pfam_t_path,emb_q_path,emb_t_path,fa_q_path,fa_t_path):
    ...
    res=filter(clan_search_result,pfam_search_result,indices,q_ids,t_id_dict)
...
if __name__ == '__main__':
    ...
    fa_q_path=args.fa_q
    fa_t_path=args.fa_t
    pipeline(out_path,pfam_q_path,pfam_t_path,emb_q_path,emb_t_path,fa_q_path,fa_t_path)
